      ...
      <div class="bg-white dark:bg-surface-900 rounded-xl shadow-2xl p-8">
        ...
        <div class="space-y-4">
          <div>
            ...
            <div class="relative">
              <div class="absolute left-3 top-1/2 transform -translate-y-1/2 text-surface-400 dark:text-surface-500">
              ...
              <input
                ...
                class="w-full pl-11 pr-4 py-3 border border-surface-300 dark:border-surface-600 rounded-lg focus:ring-2 focus:ring-primary focus:border-transparent bg-surface-50 dark:bg-surface-800 text-surface-900 dark:text-surface-100"
              />
            </div>
          </div>
