export const PAN_DOMAIN = 'https://drive.uc.cn'
export const DRIVE_DOMAIN = 'https://pc-api.uc.cn'
export const DRIVE_H_DOMAIN = 'https://pc-api.uc.cn'
...
export interface UCListResponse {
  data: {
    list: UCFileInfo[]
  }
  errno: number
...
export interface UCSearchResponse {
  status: number
  code: number
  message: string
  timestamp: number
...
export interface UCCloudDriveConfig {
  cookies: string
}
